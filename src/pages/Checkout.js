        ...
        <div className="row">
          <div className="col-7">
            <div className="checkout-left-data">
              ...
              <p className="user-details total">Gia Minh (vogiaminh0802@gmail.com)</p>
          ...
          <div className="col-5">
              ...
              <div className="d-flex gap-10 mb-2 align-items-center">
                <div className='w-75 d-flex gap-10'>
                  <div className='w-25 position-relative'>
                    <span style={{ "top": "-5px", "right": "-5px" }} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">1</span>
                    <img className='img-fluid' src={watch} alt="productimg" />
                  </div>
                  <div>
                    <h5 className="total-price">Apple Watch Series 7</h5>
                    <p className="total-price">S / Black</p>
                  </div>
                </div>
                <div className='flex-grow-1'>
            ...
            <div className='d-flex justify-content-between align-items-center py-4'>
              ...
              <h5 className='total-price'>$119.65</h5>
            </div>
          </div>
        </div>
      </Container>
